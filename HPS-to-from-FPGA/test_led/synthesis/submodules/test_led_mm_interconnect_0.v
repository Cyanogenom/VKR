...
`timescale 1 ps / 1 ps
module test_led_mm_interconnect_0 (
	...
	wire   [20:0] ledr_s1_agent_m0_address;                                 // LEDR_s1_agent:m0_address -> LEDR_s1_translator:uav_address
	...
	wire          ledr_s1_agent_rp_valid;                                   // LEDR_s1_agent:rp_valid -> router_002:sink_valid
	wire  [111:0] ledr_s1_agent_rp_data;                                    // LEDR_s1_agent:rp_data -> router_002:sink_data
	wire          ledr_s1_agent_rp_ready;                                   // router_002:sink_ready -> LEDR_s1_agent:rp_ready
	wire          ledr_s1_agent_rp_startofpacket;                           // LEDR_s1_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          ledr_s1_agent_rp_endofpacket;                             // LEDR_s1_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                        // cmd_mux:src_valid -> LEDR_s1_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_src_data;                                         // cmd_mux:src_data -> LEDR_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                        // LEDR_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                      // cmd_mux:src_channel -> LEDR_s1_burst_adapter:sink0_channel
	wire          cmd_mux_src_startofpacket;                                // cmd_mux:src_startofpacket -> LEDR_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_src_endofpacket;                                  // cmd_mux:src_endofpacket -> LEDR_s1_burst_adapter:sink0_endofpacket
	wire          ledr_s1_burst_adapter_source0_valid;                      // LEDR_s1_burst_adapter:source0_valid -> LEDR_s1_agent:cp_valid
	wire  [111:0] ledr_s1_burst_adapter_source0_data;                       // LEDR_s1_burst_adapter:source0_data -> LEDR_s1_agent:cp_data
	wire          ledr_s1_burst_adapter_source0_ready;                      // LEDR_s1_agent:cp_ready -> LEDR_s1_burst_adapter:source0_ready
	wire    [1:0] ledr_s1_burst_adapter_source0_channel;                    // LEDR_s1_burst_adapter:source0_channel -> LEDR_s1_agent:cp_channel
	...
	wire          ledr_s1_agent_rdata_fifo_out_valid;                       // LEDR_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] ledr_s1_agent_rdata_fifo_out_data;                        // LEDR_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          ledr_s1_agent_rdata_fifo_out_ready;                       // avalon_st_adapter:in_0_ready -> LEDR_s1_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                            // avalon_st_adapter:out_0_valid -> LEDR_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                             // avalon_st_adapter:out_0_data -> LEDR_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                            // LEDR_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                            // avalon_st_adapter:out_0_error -> LEDR_s1_agent:rdata_fifo_sink_error
	...
	test_led_mm_interconnect_0_router router (
	...
	test_led_mm_interconnect_0_router router_001 (
	...
	test_led_mm_interconnect_0_router_002 router_002 (
	...
	test_led_mm_interconnect_0_router_002 router_003 (
	...
	test_led_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	test_led_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                                       //        clk.clk
		.reset              (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	test_led_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (LEDR_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                          //       clk.clk
		.reset               (LEDR_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (LEDR_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                          //       clk.clk
		.reset              (LEDR_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                                       //       clk.clk
		.reset               (hps_0_h2f_lw_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	test_led_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
